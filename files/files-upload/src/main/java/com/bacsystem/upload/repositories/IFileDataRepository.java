...
/**
 * <b>IFileDataRepository</b>
 * <p>
 * This class specifies the requirements for the {@link IFileDataRepository} component,
 ...
 */
@Repository
public interface IFileDataRepository extends CrudRepository<FileDataEntity,Long> {
    ...
    @Query(value = "SELECT fd.id as id, fd.uuId as uuId, fd.name as name, " +
            ...
            "FROM FileDataEntity fd WHERE fd.uuId =:uuId")
